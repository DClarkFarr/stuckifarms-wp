...
function property_cpt() { 
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			*/
			...
			array(
				'key' => 'field_property_info_builder',
				'label' => 'Builder',
				'name' => 'builder_id',
				'type' => 'post_object',
				'post_type' => [
	...
	register_post_type( 'builder', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 
			'labels' => array(
				'name' => __( 'Builders' ), /* This is the Title of the Group */
				'singular_name' => __( 'Builder' ), /* This is the individual type */
				'all_items' => __( 'All Builders' ), /* the all items menu item */
				'add_new' => __( 'Add New' ), /* The add new menu item */
				'add_new_item' => __( 'Add New Builder' ), /* Add New Display Title */
				'edit' => __( 'Edit' ), /* Edit Dialog */
				'edit_item' => __( 'Edit Builders' ), /* Edit Display Title */
				'new_item' => __( 'New Builder' ), /* New Display Title */
				'view_item' => __( 'View Builder' ), /* View Display Title */
				'search_items' => __( 'Search Builder' ), /* Search Custom Type Title */ 
				'not_found' =>  __( 'Nothing found in the Database.' ), /* This displays if there are no entries yet */ 
				'not_found_in_trash' => __( 'Nothing found in Trash' ), /* This displays if there is nothing in the trash */
				'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is the example Builder' ), /* Custom Type Description */
			'public' => true,
			'publicly_queryable' => true,
			'exclude_from_search' => true,
			'show_ui' => true,
	...
	register_post_type( 'faq', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 
			'labels' => array(
				...
				'edit' => __( 'Edit' ), /* Edit Dialog */
				'edit_item' => __( 'Edit FAQs' ), /* Edit Display Title */
				'new_item' => __( 'New FAQ' ), /* New Display Title */
				'view_item' => __( 'View FAQ' ), /* View Display Title */
				'search_items' => __( 'Search FAQ' ), /* Search Custom Type Title */ 
				'not_found' =>  __( 'Nothing found in the Database.' ), /* This displays if there are no entries yet */ 
				'not_found_in_trash' => __( 'Nothing found in Trash' ), /* This displays if there is nothing in the trash */
				'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is the example FAQ' ), /* Custom Type Description */
			'public' => true,
			...
			'menu_position' => 50, /* this is what order you want it to appear in on the left hand side menu */ 
			'menu_icon' => get_img_directory() . '/dashboard-fa-suitcase.png', /* the icon for the custom post type menu */
			//'rewrite'	=> array( 'slug' => 'faq', 'with_front' => false, 'feed' => true ), /* you can specify its url slug */
			'has_archive' => false, //'custom_type', /* you can rename the slug here */
			'capability_type' => 'post',
			'hierarchical' => false,
			/* the next one is important, it tells what's enabled in the post editor */
